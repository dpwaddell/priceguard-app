    ...
    <div class="grid">
      <div class="stack">
        <div class="card">
          ...
          <div class="actions">
            <button type="button" class="btn primary" onclick="window.location.href='${tierUrl}'">Create first tier</button>
            <button class="btn" onclick="alert('Next build: CSV import screen')">Import CSV</button>
            <button type="button" class="btn" onclick="window.location.href='${assignmentsUrl}'">Assign customer</button>
          </div>
